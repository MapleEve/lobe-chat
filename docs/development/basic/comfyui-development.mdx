...
This rewritten documentation is based on actual code implementation:
...
Developers can now use this accurate documentation to extend ComfyUI integration functionality.
